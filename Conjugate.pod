...
whose i'th element is the i'th person, for i in 1-4,6. This options
renders ineffective all other options except 'i' and 'x'.
...
'you'=2, 'she/he'=3, 'we'=4, 'they'=6. Second person plural, which
would be '5' is not implemented. All numbers other that 1-4,6 are
ignored. Default is 1-4,6.
